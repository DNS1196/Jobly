...
describe("GET /companies", function () {
  ...
  test("returns companies with name containing '3'", async function () {
  ...
  test("returns companies with at least 2 employees", async function () {
  ...
  test("returns companies with no more than 2 employees", async function () {
  ...
  test("bad request if invalid filter key", async function () {
    const resp = await request(app).get("/companies?genericFilter = blue")
    expect(resp.statusCode).toEqual(400);
  });
});
