...
describe("findAll", function () {
  ...
  test("works: filters by minEmployees and maxEmployees", async function () {
  ...
  test("throws BadRequestError if minEmployees is greater than maxEmployees", async function () {
    try {
